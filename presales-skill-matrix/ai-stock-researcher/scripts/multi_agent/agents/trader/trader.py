...
from multi_agent.agents.schemas import TraderProposal, render_trader_proposal
from multi_agent.agents.utils.agent_utils import build_instrument_context, get_language_instruction
from multi_agent.agents.utils.structured import (
    bind_structured,
